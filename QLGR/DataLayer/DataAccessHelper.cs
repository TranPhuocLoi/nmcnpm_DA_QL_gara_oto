...
namespace QLGR.DataLayer
{
    class DataAccessHelper
    {
        ...
        public DataAccessHelper ()
        {
            ...
            // Sửa cái Conenction string này thành cái Connect của em nè ?
            // Biết làm không ? hoonggggg a làm demo giùm e nhan.
            // Vãi 3.
            // Cái đầu tiên của làm phần mềm luôn á.
            
            String connectionString = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=QLGR;Data Source=DESKTOP-PS48J6N\SQLEXPRESS";
